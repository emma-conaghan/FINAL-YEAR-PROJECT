...
<br>
<a href="{{ url_for('file_list') }}">View uploaded files</a>
'''
...
<br>
<a href="{{ url_for('upload_file') }}">Upload a new file</a>
'''
...
def upload_file():
    ...
    return render_template_string(HTML_UPLOAD_PAGE)

@app.route('/files')
def file_list():
    files = os.listdir(app.config['UPLOAD_FOLDER'])
    return render_template_string(HTML_LIST_PAGE, files=files)
