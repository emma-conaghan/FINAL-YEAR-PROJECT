...
<head>
    ...
    <style>
        ...
        h1, h2 { color: #2c3e50; }
        input[type="text"], input[type="password"] { width: 100%; padding: 12px; margin: 8px 0 16px 0; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; }
...
WELCOME_TEMPLATE = BASE_TEMPLATE.replace('{% block content %}{% endblock %}', '''
    ...
    {% if is_admin %}
        <div style="margin-top: 20px; padding: 15px; background: #eaf2e3; border-radius: 4px;">
            <strong>Admin Notice:</strong> You have administrator privileges.
