...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .note-card .actions a.edit { color: #4a90d9; }
        .note-card .actions a.delete { color: #e74c3c; }
        ...
        .empty-state p { font-size: 1.2em; margin-bottom: 16px; }
        .flash-message {
            padding: 12px 16px;
            border-radius: 4px;
            margin-bottom: 20px;
...
{% block content %}
    <div class="note-card">
        ...
        <div class="actions" style="margin-top: 16px;">
            <a href="{{ url_for('edit_note', note_id=note['id']) }}" class="btn btn-primary" style="text-decoration:none;font-size:0.9em;padding:8px 16px;">Edit</a>
            <a href="{{ url_for('index') }}" class="btn btn-secondary" style="text-decoration:none;font-size:0.9em;padding:8px 16px;margin-left:8px;">Back to Notes</a>
        </div>
    </div>
{% endblock %}
'''
