...
<head>
    ...
    <style>
        ...
        button, input[type="submit"] { background: #2c3e50; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; }
...
<p>This is your dashboard. Use the navigation above to access different sections.</p>
{% if is_admin %}
