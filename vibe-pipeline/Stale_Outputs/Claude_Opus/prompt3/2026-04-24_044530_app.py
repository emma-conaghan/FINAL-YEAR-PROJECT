...
def login():
    ...
    return render_page(LOGIN_PAGE, error=error)
...
def register():
    ...
    return render_page(REGISTER_PAGE, error=error, success=success)

@app.route('/welcome')
def welcome():
    if 'username' not in session:
        return redirect(url_for('login'))
    return render_page(WELCOME_PAGE,
