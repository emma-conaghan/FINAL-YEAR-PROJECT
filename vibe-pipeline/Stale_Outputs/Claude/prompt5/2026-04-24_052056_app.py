...
.file-list li { padding: 10px; border-bottom: 1px solid #ddd; display: flex; align-items: center; justify-content: space-between; }
...
<ul class="file-list">
  {% for f in files %}
  <li>
    <span><span class="file-icon">📄</span><a href="/view/{{ f }}" target="_blank">{{ f }}</a></span>
